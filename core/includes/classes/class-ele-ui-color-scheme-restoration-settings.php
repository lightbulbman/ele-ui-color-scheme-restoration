 ...
 * 
 * ELEUICOLOR->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Ele_Ui_Color_Scheme_Restoration_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		ELEUICOLOR
 * @subpackage	Classes/Ele_Ui_Color_Scheme_Restoration_Settings
...
class Ele_Ui_Color_Scheme_Restoration_Settings{
	...
	/**
	 * Our Ele_Ui_Color_Scheme_Restoration_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = ELEUICOLOR_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'ELEUICOLOR/settings/get_plugin_name', $this->plugin_name );
	}
}
